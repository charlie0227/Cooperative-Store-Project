...
<textarea name="content" id="company_content" style="width:90%;height:50%;"></textarea></br>
<input class = "abutton" style="width: auto;" type="button" value="返回" name="submit" onclick="select_company(<?echo $_GET['store_id']?>)">
<input class = "abutton" style="width: auto;" type="button" value="送出" name="submit" onclick="contract_application_submit()">
</form>
