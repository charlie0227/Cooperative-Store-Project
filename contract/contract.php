...
if($who=='store'){
	$data->contract='<div style="height:200px;">
					...
					<div class="auto_calculate" style="height:auto;width=:100%;display:-webkit-box;">
...
if($who=='view' || $flag=='view'){
	$data->contract='<div class="auto_calculate" style="height:auto;width=:100%;display:-webkit-box;color:blue;border-style:dashed;">
						<div style="width:50%;line-height:40px;" id="contract_content"></div>
						<div style="width:50%" id="show_discount"></div>
					</div>
					<p>備註</p>
					<p id="contract_remark" style="width: 100%;min-height:80px;color:blue;display:inline-block;"></p>';
}
