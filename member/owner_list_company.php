...
while($result=$sth->fetchObject()){?>
	...
	<td><input class="member_option" style="width: auto; background: #E78F8E;"type="button" value="管理" onclick="show_own_company_content(<?echo $result->company_id?>)"></td>
		<td><a href="#" class="big-link" data-reveal-id="show_box"><input class="member_option" style="width: auto; background: #E78F8E;"type="button" value="合約列表" onclick="show_contract(<?echo $result->company_id?>,1)"></a></td>
</tr>
<?}
//<a data-notifications="張順成該該叫"></a>
echo '</table>';	
?>