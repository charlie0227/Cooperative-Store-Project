...
<form style="display:inline;" action="function/register_account.php" method="POST">
	...
	<tr>
		<td class="register_input">
			<input type="text" class="k-textbox" id="register_account" name="account" value="">
			<span>*</span>
			<span id="NoSpace1" hidden>Don't type space</span>
			<span hidden>Reapted Account</span>
		</td>
	</tr>
	<tr>
		<td>Password</td>
	...
	<tr>
		<td class="register_input">
			<input class="k-textbox" type="password" id="register_password" name="password" value="">
			<span>*</span>
			<span id="NoSpace2" hidden>Don't type space</span>
		</td>
	</tr>			
	<tr>
		<td>name</td>
	...
	<tr>
		<td class="register_input">
			<input class="k-textbox" type="text" id="name" name="name" value="">
			<span>*</span>
			<span id="NoSpace3" hidden>Don't type space</span>
		</td>
	</tr>		
	<tr>
		<td>Phone</td>
	...
	<tr>
		<td class="register_input">
			<input class="k-textbox" type="text" id="phone" name="phone" value="">
			<span>*</span>
			<span id="NoSpace4" hidden>Don't type space</span>
		</td>
	</tr>	
	<tr>
		<td>Gender</td>
	...
	<tr>
		<td>
			<input type="radio" id="male" name="gender" value="1" class="gender_input">
			<label for "male">Male</label>
			<input type="radio" id="female" name="gender" value="0" class="gender_input">
